...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UITabBarController *tb = (UITabBarController *)self.window.rootViewController; PhotoSearchViewController *toViewController0 =
    [tb.viewControllers objectAtIndex:0]; toViewController0.searchResults = self.searchResults;
    
    PictureResultsViewController *toViewController1 =[[[tb.viewControllers objectAtIndex:1] childViewControllers] objectAtIndex:0];
    toViewController1.searchResults = self.searchResults;
    
    ImageViewController *toViewController2 = [tb.viewControllers objectAtIndex:2];
